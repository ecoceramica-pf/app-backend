...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ofertas_residuos', function (Blueprint $table) {
            ...
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade')->comment('Fábrica que disponibilizou o resíduo');
            $table->foreignId('endereco_id')->constrained('enderecos')->onDelete('cascade')->comment('Localização de retirada da oferta');
            $table->foreignId('material_id')->constrained('materiais')->onDelete('cascade')->comment('Tipo do material ofertado');
